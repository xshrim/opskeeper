...
import { onMount, tick } from 'svelte';
  ...
  import ResourcesPage from './features/resources/ResourcesPage.svelte';
...
<ResourcesPage
        ...
        bind:resourceAddMenuOpen={resourceAddMenuOpen}
        toggleResourceAddMenu={toggleResourceAddMenu}
        resourceCatalogItems={resourceCatalogItems}
        bind:selectedResourceId={selectedResourceId}
        ...
        selectedResourceCanDelete={selectedResourceCanDelete}
        selectedResourceHasConnector={selectedResourceHasConnector}
        selectedScopeId={selectedScopeId}
        testSelectedResourceConnection={testSelectedResourceConnection}
        updateSelectedResource={updateSelectedResource}
        selectedResourceCanUpdate={selectedResourceCanUpdate}
        scopeName={scopeName}
        capabilityName={capabilityName}
        bind:relations={relations}
        bind:topology={topology}
        bind:relationTarget={relationTarget}
        bind:relationType={relationType}
        createRelation={createRelation}
        deleteRelation={deleteRelation}
        resources={resources}
        selectedSchema={selectedSchema}
        resourceSchemaFieldRequired={resourceSchemaFieldRequired}
        resourceSubtypeOptionsFor={resourceSubtypeOptionsFor}
        ...
        bind:editResourceConfig={editResourceConfig}
        bind:editResourceSensitiveValues={editResourceSensitiveValues}
        bind:resourceEditorOpen={resourceEditorOpen}
        bind:resourceKind={resourceKind}
        ...
        bind:editingProviderResourceId={editingProviderResourceId}
        bind:editingResourceId={editingResourceId}
        ...
        bind:providerModels={providerModels}
        bind:providerModelDraft={providerModelDraft}
        bind:editingProviderModelName={editingProviderModelName}
        bind:providerDefaultModel={providerDefaultModel}
        bind:providerPurposeTags={providerPurposeTags}
        bind:mcpTransport={mcpTransport}
        bind:mcpURL={mcpURL}
        ...
        bind:mcpDraftTest={mcpDraftTest}
        bind:mcpDraftTestBusy={mcpDraftTestBusy}
        bind:mcpConfigurationAttempted={mcpConfigurationAttempted}
        bind:providerConfigurationAttempted={providerConfigurationAttempted}
        bind:providerModelConfigurationAttempted={providerModelConfigurationAttempted}
        bind:providerDraftTest={providerDraftTest}
        bind:providerDraftTestBusy={providerDraftTestBusy}
        bind:providerDraftTestPassedState={providerDraftTestPassedState}
        bind:resourceTypeSelectionAttempted={resourceTypeSelectionAttempted}
        bind:resourceBasicConfigurationAttempted={resourceBasicConfigurationAttempted}
        activeMessage={activeMessage}
        activeMessageTone={activeMessageTone}
        ...
        continueResourceAdd={continueResourceAdd}
        continueProviderAdd={continueProviderAdd}
        mcpHeaderCount={mcpHeaderCount}
        testMCPDraftConnection={testMCPDraftConnection}
        providerBaseURLValid={providerBaseURLValid}
        selectProviderType={selectProviderType}
        toggleProviderPurpose={toggleProviderPurpose}
        ...
        submitProviderCreate={submitProviderCreate}
        createResource={createResource}
        updateMCPFromWorkflow={updateMCPFromWorkflow}
        parseLabels={parseLabels}
        resourceSchemaForSelection={resourceSchemaForSelection}
        activeScopeSummary={activeScopeSummary}
        selectResourceAddCategory={selectResourceAddCategory}
      />
        <InspectionPage
