...
<div class="provider-fields">
  {#if accessMode === 'direct'}
    ...
    <label><span>用户名</span><input bind:value={username} on:input={onConfigurationChange} /></label><label><span>密码</span><input type="password" bind:value={password} on:input={onConfigurationChange} /></label>
