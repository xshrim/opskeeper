...
SELECT resource.id, 1,
  ...
  JOIN (VALUES
	    ...
	    ('PostgreSQL 健康诊断', '只调用 PostgreSQL 固定只读工具；不得请求写 SQL。输出 JSON，且必须包含 facts、findings、evidence、hypotheses、confidence 和 recommendations。', '["PostgreSQL"]', '[{"name":"postgresql_health","description":"检查 PostgreSQL 健康。","input_schema":{"type":"object","additionalProperties":false}},{"name":"postgresql_tables","description":"读取用户表统计。","input_schema":{"type":"object","additionalProperties":false}},{"name":"postgresql_table_columns","description":"读取指定用户表列信息。","input_schema":{"type":"object","required":["schema","table"],"properties":{"schema":{"type":"string"},"table":{"type":"string"}},"additionalProperties":false}},{"name":"postgresql_performance","description":"读取性能与配置。","input_schema":{"type":"object","additionalProperties":false}},{"name":"postgresql_vacuum","description":"读取 VACUUM 配置。","input_schema":{"type":"object","additionalProperties":false}},{"name":"postgresql_extensions","description":"读取扩展信息。","input_schema":{"type":"object","additionalProperties":false}},{"name":"postgresql_database_info","description":"读取数据库概要。","input_schema":{"type":"object","additionalProperties":false}}]'),
	    ('Redis 健康诊断', '只调用 Redis 固定只读工具；不得请求写命令。输出 JSON，且必须包含 facts、findings、evidence、hypotheses、confidence 和 recommendations。', '["Redis"]', '[{"name":"redis_health","description":"检查 Redis 健康。","input_schema":{"type":"object","additionalProperties":false}},{"name":"redis_memory","description":"读取内存统计。","input_schema":{"type":"object","additionalProperties":false}},{"name":"redis_clients","description":"读取客户端统计。","input_schema":{"type":"object","additionalProperties":false}},{"name":"redis_replication","description":"读取复制状态。","input_schema":{"type":"object","additionalProperties":false}},{"name":"redis_slowlog","description":"读取慢日志。","input_schema":{"type":"object","additionalProperties":false}},{"name":"redis_database_info","description":"读取数据库信息。","input_schema":{"type":"object","additionalProperties":false}}]'),
